...
export default function SkillCard({skill, icon, proficiency, color, width, iconColor}){
   ...
   return(
    <div className="w-full h-45 rounded-lg flex flex-col items-center justify-start gap-2 bg-white cursor-pointer text-black shadow-md shadow-gray-300 dark:shadow-gray-500">
      ...
      <div className="w-full h-3 px-1 mt-1">
...
<div className="w-full border border-gray-500 mt-1"></div>
    ...
    <div className="w-full flex items-start py-2 px-4">
