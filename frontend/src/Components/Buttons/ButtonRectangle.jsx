...
export default function ButtonRectangle({width, height, btnText, onClick, textSize, bgNone, type, disabled, onMouseEnter}){
  ...
  cursor-pointer grid place-items-center`} onClick={onClick} type={type}
