...
import useDownload from "../../Hooks/douwnloadButton";
...
export default function CertificateCard({src, heading, description, rowNumber = "odd"}) {
  ...
  return (
    ...
    <ButtonRectangle width="w-40" btnText={downloading ? "Downloading..." : "Download"} height="h-10" textSize="text-lg" onClick={() => downloadFile(src, heading)}/>
    </div>
</div>
  )
}