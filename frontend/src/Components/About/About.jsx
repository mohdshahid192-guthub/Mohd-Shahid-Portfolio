...
const [isvisible, setIsVisible] = useState(false)
  ...
  return(
   <div className='min-h-[calc(100vh-16px)] bg-[#ffffff] grid grid-cols-1 md:grid-cols-2 place-items-center px-4 relative z-0 dark:bg-slate-800 dark:text-white py-16 '>
